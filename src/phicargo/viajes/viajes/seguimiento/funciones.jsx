...
export const useJourneyDialogs = () => {
    ...
    const iniciar_viaje = () => {
        Swal.fire({
            ...
            imageUrl: '/phicargo/img/status/start.png',
            imageWidth: 150,
            imageHeight: 150,
    ...
    const finalizar_viaje = () => {
        Swal.fire({
            ...
            imageUrl: '/phicargo/img/status/final.gif',
            imageWidth: 200,
            imageHeight: 200,
            imageAlt: 'Imagen',
            showCancelButton: true,
    ...
    const reactivar_viaje = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios.post('/phicargo/viajes/funciones/reactivarViaje.php', data)
                    .then(response => {
                        if (response.data === 1) {
    ...
    const enviar_estatus = async (id_viaje, id_estatus, archivos, comentarios) => {
        ...
        try {
            ...
            const response = await axios.post('/phicargo/viajes/algoritmos/envio_manual.php', data);
    ...
    const reenviar_estatus = async (id_viaje, id_reporte, id_estatus, archivos, comentarios) => {
        ...
        try {
            ...
            const response = await axios.post('/phicargo/viajes/algoritmos/reenvio.php', data);
    ...
    const comprobar_operador = async () => {
        try {
            ...
            const response = await axios.post('/phicargo/viajes/funciones/comprobarOperador.php', data);
    ...
    const comprobar_disponibilidad = async () => {
        try {
            ...
            const response = await axios.post('/phicargo/viajes/disponibilidad/comprobar_disponibilidad.php', data);
    ...
    const cambiar_estado_equipo = async (estado) => {
        try {
            ...
            const response = await axios.post('/phicargo/viajes/disponibilidad/cambiar_estados.php', data);
