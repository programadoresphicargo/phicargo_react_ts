...
export default function ReporteOperador({ id_reporte, open, onClose }) {
    ...
    const getEstatus = async () => {
        try {
            setLoading(true);
            const response = await fetch('/phicargo/viajes/problemas_operadores/getReporte.php', {
                method: 'POST',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await fetch('/phicargo/viajes/problemas_operadores/atenderReporte.php', {
                method: 'POST',
